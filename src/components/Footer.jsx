...
function Footer() {
  return (
    <div className="flex gap-5w-full h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Neue Montreal'] ">
        <div className="heading">
          <h1 className="text-[5vw]  uppercase -mb-10 font-semibold">Eye-</h1>
          <h1 className="text-[5vw]  uppercase -mb-10 font-semibold">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-['Neue Montreal'] font-sm">
            <a className="block text-xl font-light mt-10" href="">Facebook</a>
            <a className="block text-xl font-light mt-10" href="">Instagram</a>
            <a className="block text-xl font-light mt-10" href="">Twiiter</a>
          </div>
      </div>
    </div>
  );
